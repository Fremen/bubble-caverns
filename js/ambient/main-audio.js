...
const DEBUG_AUDIO = params.get('debugAudio') === '1';
if (DEBUG_AUDIO) window.__audioDebug = () => AudioSys.debugState();
...
function unlockAudio() {
  AudioSys.unlock();
  if (DEBUG_AUDIO) {
    setTimeout(() => { canvas.dataset.audioDebug = JSON.stringify(AudioSys.debugState()); }, 120);
  }
}
